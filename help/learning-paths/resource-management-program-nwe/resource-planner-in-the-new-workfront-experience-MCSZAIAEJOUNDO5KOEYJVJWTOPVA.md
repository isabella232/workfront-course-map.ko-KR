...
리소스 플래너 Workfront One 학습 경로 가 (으)로 마이그레이션되었습니다. [리소스 플래너에서 리소스 보기 및 비교](https://experienceleague.adobe.com/?recommended=Workfront-L-1-2022.1.resourceplanner){target="_blank"} Experience League 과정.
